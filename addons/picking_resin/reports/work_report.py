...
class WorkReport(models.Model):
    ...
    _name = 'picking_resin.work_report'
    _description = 'Work Report'

    _table = 'picking_resin_work_report'
    ...
    def init(self):
        tools.drop_view_if_exists(self.env.cr, 'picking_resin_work_report')
        self.env.cr.execute(
            u"""
            CREATE OR REPLACE VIEW picking_resin_work_report AS (
            SELECT
                emp_lst.id as id,
